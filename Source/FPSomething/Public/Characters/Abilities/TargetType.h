 ...
 */
UCLASS()
class FPSOMETHING_API UTargetType : public UObject
{
	GENERATED_BODY()
...
class FPSOMETHING_API UTargetType_UseOwner : public UTargetType
{
	GENERATED_BODY()
...
UCLASS(NotBlueprintable)
class FPSOMETHING_API UTargetType_UseEventData : public UTargetType
{
	GENERATED_BODY()
