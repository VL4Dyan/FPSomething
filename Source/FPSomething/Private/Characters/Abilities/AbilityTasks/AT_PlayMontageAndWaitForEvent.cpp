...
UFPSmthAbilitySystemComponent* UAT_PlayMontageAndWaitForEvent::GetTargetASC()
{
...
UAT_PlayMontageAndWaitForEvent* UAT_PlayMontageAndWaitForEvent::PlayMontageTask(UGameplayAbility* OwningAbility,
